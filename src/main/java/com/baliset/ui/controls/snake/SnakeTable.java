...
import com.baliset.ui.controls.tablex.NavTable;
import com.baliset.ui.controls.tablex.TableColumnFactory;
import com.baliset.ui.controls.tablex.TableColumnRepository;
...
public class SnakeTable extends NavTable
{
  ...
  class ColumnTracker
  {
    ...
    boolean isOpenForMove()
    {
      return moving_;
    }

    boolean isOpenForResize()
    {
      return resizing_;
    }
